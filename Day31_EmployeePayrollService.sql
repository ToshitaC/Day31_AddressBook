...
values('ABC',40000,'2022-09-29');

insert into employee_payroll(name,salary,startdate)
values('DEF',75000,'2021-04-16');

insert into employee_payroll(name,salary,startdate)
values('HIJ',65000,'2021-10-15');

insert into employee_payroll(name,salary,startdate)
values('XYZ',85000,'2021-11-18');

insert into employee_payroll(name,salary,startdate,gender)
values('RST',10000,'2021-05-18','M');
...
select *from employee_payroll;
select * from employee_payroll
WHERE startdate BETWEEN CAST('2021-08-16'AS DATE)
